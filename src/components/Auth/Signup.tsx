...
export default function Signup({ onSignup, onSwitchToLogin, onBackToUserType, userType }: SignupProps) {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${userType === 'student' ? 'from-green-50 to-emerald-100 dark:from-green-900 dark:to-emerald-800' : 'from-purple-50 to-indigo-100 dark:from-purple-900 dark:to-indigo-800'} flex items-center justify-center p-4 transition-colors duration-300`}>
              ...
              <div className="flex gap-4 mb-4">
                <div className="relative w-1/2">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <div>
              ...
              <div className="relative mb-4">
                <input 
                  ...
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            ...
            <div>
              ...
              <div className="relative mb-4">
                <input 
                  type="text" 
                  placeholder="Street" 
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 ${userType === 'student' ? 'focus:ring-green-500' : 'focus:ring-purple-500'} focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400`}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
          ...
          <div className="text-center">
            <p className="text-gray-600 dark:text-gray-300">
              ...
              <button
                ...
                className={`${userType === 'student' ? 'text-green-600 dark:text-green-400' : 'text-purple-600 dark:text-purple-400'} font-semibold hover:underline`}
              >
                Sign in
              </button>
            </p>
